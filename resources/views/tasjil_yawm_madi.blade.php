...
<div class="container text-center" >
    <div class="row text-center">
        ...
        <form action="/tasjil_yawm_madi/{{$id}}" method="post" >
            {{ csrf_field() }}
          ...
          if($l=='Friday'){$jour='الجمعة';};
          if($l=='Thursday'){$jour='الخميس';};
          if($l=='Wednesday'){$jour='الأربعاء';};
          if($l=='Saturday'){$jour='السبت';};
          if($l=='Sunday'){$jour='الأحد';};
          if($l=='Monday'){$jour='الإثنين';};
          if($l=='Tuesday'){$jour='الثلاثاء';};
				echo $jour;
$j=$l;
@endphp
                {{$y}}/{{$m}}/{{$d}}
    ...
    margin-bottom: -8px;" class="col-sm-12 form-group">
                ...
                <th style="width:100px;" >
                   ...
                   <div class="radio">
                       <label ><input type="radio" value="true" name="{{$myTasjil_elyawm->id}}" 
                ...
                <th style="width:100px;">
                    <div class="radio">
                        <label><input type="radio" value="false" name="{{$myTasjil_elyawm->id}}" 
								checked
							>لا </label>
    </div>
